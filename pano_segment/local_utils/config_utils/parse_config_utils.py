...
# sam_cfg = Config(config_path='./pano_segment/config/sam.yaml')
# clip_cfg = Config(config_path='./pano_segment/config/clip.yaml')
# cluster_cfg = Config(config_path='./pano_segment/config/cluster.yaml')
