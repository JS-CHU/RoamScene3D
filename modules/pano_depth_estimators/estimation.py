...
sys.path.append(parent_dir + "/pano_depth_estimators/360monodepth/code/python/src/") 


from utility import blending, image_io, depthmap_utils, serialization, subimage
...
class Pano_depth_estimation:
    ...
    def depth_alignment(self):
        ...
        depthmap_aligner = DepthmapAlign(self.opt, self.depth_align_dir, self.subimg_rgb_list, debug=False)
