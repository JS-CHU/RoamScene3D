...
parser.add_argument('--save_dir', type=str, default="32")
parser.add_argument('--prompt', type=str, default="Secluded waterfall, hidden sanctuary.")
parser.add_argument('--lora_path', type=str, default='./checkpoints/pano_lora_720%2A1440_v1.safetensors') 
